...
class AddVessel:
    ...
    def GetResources(self):
        ...
        return {
            'Pixmap': str(Path(App.getUserAppDataDir()) / "Mod" / "WoodTurningWorkbench_alt" / "resources" / "icons" / "AddVase.svg"),
        ...
        class AddVesselPanel:
            ...
            def __init__(self):
                ...
                def add_vessel_button(vessel_number):
                    ...
                    """
                    image_path = Path(FreeCAD.getUserAppDataDir()) / "Mod" / "WoodturningWorkbench_alt" / "resources" / "media" / f"vase{vessel_number}.png"
            ...
            def bt_add_vessel_clicked(self, vase_name):
                ...
                try:
                    ...
                    from pathlib import Path
                    #vase_name = "vase1.svg"
                    image = str(Path(FreeCAD.getUserAppDataDir()) / "Mod" / "WoodturningWorkbench_alt" / "resources" / "media" / vase_name )
                    #image += "vase1.png"
